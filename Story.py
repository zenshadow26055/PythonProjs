...
def pinch():
  print("You pinched you self but you found yourself not dreaming.So you are holding the folded note and the ring")
...
def ent_build():
  print("You had entered to the old small building but onece you entered it had smelt kind of bad and the door behind you had slamed on you. You had seen a man standing in a small distance.")
